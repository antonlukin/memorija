...
function Welcome({ setRules }) {
  return (
    <div className={styles.welcome}>
      <p className={styles.title}>Select game type</p>

      <div className={styles.options} onClick={() => { setRules('flag') }}>
        ...
        <button className={styles.button} onClick={() => setRules('country')}>
        ...
        <button className={styles.button} onClick={() => setRules('capital')}>
        ...
        <button className={styles.button} onClick={() => setRules('random')}>
